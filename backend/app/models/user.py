...
class User(Base):
    ...
    tryon_model_image_path: Mapped[str | None] = mapped_column(String(500))
    ...
    tryon_jobs: Mapped[list["OutfitTryOn3DJob"]] = relationship(
        "OutfitTryOn3DJob", back_populates="user", cascade="all, delete-orphan"
    )
