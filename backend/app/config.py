...
class Settings(BaseSettings):
    ...
    fashn_api_key: str | None = Field(default=None)
    fashn_run_url: str = Field(default="https://api.fashn.ai/v1/run")
    fashn_status_url: str = Field(default="https://api.fashn.ai/v1/status")
    meshy_api_key: str | None = Field(default=None)
    meshy_image_to_3d_url: str = Field(default="https://api.meshy.ai/openapi/v1/image-to-3d")
